...
<br>
  ...
  <div style="margin-bottom: 10px; padding-top: 15px; padding-bottom: 15px; padding-left: 20px; border-radius: 5px; background-color: hsla(0, 0%, 62%, 0.1); max-width: 350px;">🎓 <i style="color:#F5F5F5;">..</i>M.S. in Information (UX-HCI) at UM</div>
...
<br><h3>My Background</h3>
  ...
  <figcaption class="caption">Volunteer event with Project Openhand</figcaption>
    ...
    <p>In addition to being a designer, I am also a dog dad, a gaymer, a practicer of yoga, and an avid trail runner.</p><br>
